...
- **✨ Другая сумма** — ввод числа; фраза с буквами (например «завтра созвон») → напоминание; «abc» → ошибка, режим остаётся
...
3. «Другая сумма» → «abc» → ошибка, режим остаётся
4. «Другая сумма» → «завтра созвон» → напоминание, не Stars
