...
Оглавление проекта **v3.45.4** · [v1.0 финальный статус](v1.0-final-status.md)
...
| [guides/quality-metrics.md](guides/quality-metrics.md) | Тесты (567), coverage 65%, ruff, verify_ops |
