...
Оглавление проекта **v3.46.2** · [v1.0 финальный статус](v1.0-final-status.md)
...
| [guides/quality-metrics.md](guides/quality-metrics.md) | Тесты (592), coverage 65%, ruff, verify_ops |
...
- [releases/v3.46.2.md](releases/v3.46.2.md) — **текущий:** fix `@бот` routing (tips vs create)
- [releases/v3.46.1.md](releases/v3.46.1.md) — display name preview polish
