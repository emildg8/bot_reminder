...
**Актуально:** v3.42.1 · **428** тестов · CI green
...
| J1 | GitHub Secrets полный набор | 📋 см. ops-checklist |

| J2 | Wispbyte smoke v3.42 | 📋 |

| J3 | BotFather Group Privacy + Stars | 📋 |

| J4 | `/ping` → v3.42 на проде | 📋 |
...
- [x] CHANGELOG + release note v3.42.0
