...
**Актуально (v3.45.2):** roadmap A–E + F + G + **H/I phase2** + **Stars** + **assignee v3.45** закрыты. CI green, **560** тестов, verify_ops + 3 smoke, оценки **10/10** в [improvements-plan-2026-06.md](improvements-plan-2026-06.md).
