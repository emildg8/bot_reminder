...
**Версия:** [v3.43.1](CHANGELOG.md) · **460 тестов** · [статус](docs/v1.0-final-status.md) · [план](docs/plans/improvements-plan-2026-06.md)
...
tests/          # unit + handler tests (460, см. quality-metrics.md)
