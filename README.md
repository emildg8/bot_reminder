...
**Версия:** [v3.45.3](CHANGELOG.md) · **560 тестов** · [статус](docs/v1.0-final-status.md) · [план](docs/plans/improvements-plan-2026-06.md)
...
tests/          # unit + handler tests (560, см. quality-metrics.md)
