...
**Версия:** [v3.41.0](CHANGELOG.md) · **413 тестов** · [статус](docs/v1.0-final-status.md) · [план](docs/plans/improvements-plan-2026-06.md)
...
tests/          # unit + handler tests (413, см. quality-metrics.md)
