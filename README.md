...
**Версия:** [v3.46.4](CHANGELOG.md) · **597 тестов** · [статус](docs/v1.0-final-status.md) · [план](docs/plans/improvements-plan-2026-06.md)
...
tests/          # unit + handler tests (597, см. quality-metrics.md)
...
| [docs/v1.0-final-status.md](docs/v1.0-final-status.md) | **v1.0 — финальный статус и проверки** |
...
| [docs/releases/](docs/releases/) | Release notes (`v3.46.4.md` — текущий) |
