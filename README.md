...
**Версия:** [v3.40.1](CHANGELOG.md) · **401 тестов** · [статус](docs/v1.0-final-status.md) · [план](docs/plans/improvements-plan-2026-06.md)
...
tests/          # unit + handler tests (401, см. quality-metrics.md)
