...
**Версия:** [v3.45.8](CHANGELOG.md) · **576 тестов** · [статус](docs/v1.0-final-status.md) · [план](docs/plans/improvements-plan-2026-06.md)
...
tests/          # unit + handler tests (576, см. quality-metrics.md)
