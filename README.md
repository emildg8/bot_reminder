...
**Версия:** [v3.46.0](CHANGELOG.md) · **587 тестов** · [статус](docs/v1.0-final-status.md) · [план](docs/plans/improvements-plan-2026-06.md)
...
tests/          # unit + handler tests (587, см. quality-metrics.md)
