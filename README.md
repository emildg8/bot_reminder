...
**Версия:** [v3.40.3](CHANGELOG.md) · **412 тестов** · [статус](docs/v1.0-final-status.md) · [план](docs/plans/improvements-plan-2026-06.md)
...
tests/          # unit + handler tests (412, см. quality-metrics.md)
