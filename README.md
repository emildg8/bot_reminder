...
> **v3.5.0 — дни недели, «половина четвёртого», «через три-четыре часа».** Точнее STT/NLP для голосовых напоминаний.
>
...
- Группы: `@бот …`, `@username @бот …`; управление в личке; pause/clear/TZ — только админы
